...
class LocalStorageService {
  ...
  void deleteTransactionItem(TransactionItem transaction) {
    final transactions = Hive.box<TransactionItem>(transactionsBoxKey); // get a list of our transactions
    final Map<dynamic, TransactionItem> map = transactions.toMap(); // create a map out of it
    dynamic desiredKey; 
